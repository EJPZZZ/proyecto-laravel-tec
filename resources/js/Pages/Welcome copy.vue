...
<template>
    ...
    >
        ...
        <div v-if="notification" class="w-1/2 h-96 bg-neutral-50 flex
        flex-col justify-center
        items-center text-center">
            <h1 class="text-7xl">{{notification_message}}</h1>

            <button @click="notification = !notification" 
            class="text-2xl bg-black text-white p-4">Cerrar</button>
        </div>
